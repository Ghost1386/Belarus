    ...
    <div className={styles.container}>
       ...
       <div className={styles.item}>
            ...
            <div className={styles.item__content}>
                ...
                <p className={styles.item__content_text}>Председатель Брестской областной организации РОО “Белая Русь”</p>
       ...
       <div className={styles.item}>
            ...
            <div className={styles.item__content}>
                ...
                <p className={styles.item__content_text}>Председатель Пинской городской организации РОО “Белая Русь”</p>
